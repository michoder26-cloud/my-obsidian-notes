...
- **`dual-theme-dashboard.md`** — pattern for serving multiple themed versions of a dashboard from the same Python HTTP server using query-param routing. Useful when the user wants a light theme and a pixel/retro theme side by side.
